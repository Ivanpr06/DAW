...
public class Personaje {
    ...
    private Double vida;
    private Double mana;
    private RegionPersonaje region;
    ...
    public Personaje(Integer id, String nombre, String descripcion, LocalDate fechaCreacion, Integer nivel, Double vidaBase, Double defensaBase, Double defensa, Double ataqueBase, Double ataque, Double vida, Double mana, RegionPersonaje region, List<Habilidad> habilidades, List<Item> equipamiento, Escalabilidad escalabilidad) {
        this.id = id;
        this.nombre = nombre;
    ...
    public RegionPersonaje getRegionPersonaje() {
        return region;
    }

    public void setRegionPersonaje(RegionPersonaje region) {
        this.region = region;
    }
